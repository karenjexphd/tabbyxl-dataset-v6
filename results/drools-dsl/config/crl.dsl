...
#Value editing
[consequence][] set value {string_expression} to {cell:\S+}\.label\[{index:\d+}\] = {cell}.getLabel({index}).setValue({string_expression});
[consequence][] set value {string_expression} to {cell:\S+}\.label = {cell}.getLabel().setValue({string_expression}); 
[consequence][] set value {string_expression} to {cell:\S+}\.entry\[{index:\d+}\] = {cell}.getEntry({index}).setValue({string_expression}); 
...
#Label categorizing
[consequence][] set category {category} to {cell:\S+}\.label\[{index:\d+}\] = {cell}.getLabel({index}).setCategory({category});
...
[consequence][] set parent {cell:\S+}\.label\[{index:\d+}\] to {label:\S+} = {label}.setParent({cell}.getLabel({index})); 
[consequence][] set parent {cell:\S+}\.label to {label:\S+} = {label}.setParent({cell}.getLabel()); 
[consequence][] set parent {label:\S+} to {cell:\S+}\.label\[{index:\d+}\] = {cell}.getLabel({index}).setParent({label}); 
...
[consequence][] group {label:\S+} with {cell:\S+}\.label\[{index:\d+}\] = {cell}.getLabel({index}).group({label});
[consequence][] group {label:\S+} with {cell:\S+}\.label = {cell}.getLabel().group({label});
[consequence][] group {cell:\S+}\.label\[{index:\d+}\] with {label:\S+} = {label}.group({cell}.getLabel({index}));
...
[consequence][] add label {label:\S+} to {cell:\S+}\.entry\[{index:\d+}\] = {cell}.getEntry({index}).addLabel({label});
[consequence][] add label {cell:\S+}\.label\[{index:\d+}\] to {entry:\S+} = {entry}.addLabel({cell}.getLabel({index}));
...
#Updating facts
[consequence][] update {cell:\S+}\.entry\[{index:\d+}\] = update({cell}.getEntry({index}));
[consequence][] update {cell:\S+}\.entry = update({cell}.getEntry());
[consequence][] update {cell:\S+}\.label\[{index:\d+}\] = update({cell}.getLabel({index}));
